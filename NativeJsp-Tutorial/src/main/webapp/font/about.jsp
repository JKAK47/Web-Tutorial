        ...
        <div style="font-size: 14px; margin-top: 53px; line-height: 36px;">
            <div id="tab_con">
                <div id="tab_con_1" class="active">
                    ...
                    <br>
                    <p>
                        目前，明日科技的用户人群已经超过1000万，伴随着国家数字化产业的飞速发展，依托庞大的用户资源，明日科技坚持
                        “一切以用户需求为核心，发展全方位的数字化学习服务支持平台”的发展战略，在发展原有的行业软件开发服务和IT教育出版基础上，正在全力开发数字化学习软件产品，打造全能互动数字平台。
                    </p>
                    <br>
                    <p>
...
<!--//企业简介-->
<!-- 页面底部 -->
<div id="tab_con_2"   style="text-align: center;">
