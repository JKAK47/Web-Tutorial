...
<h3> <%= ((User) request.getAttribute("user")).getName() %></h3><%-- 这个 是可以获取request 中的值 的  ，其他的不 行  , 务必保证不是空指针 --%>
<h3> <%= ((User) session.getAttribute("user")).getName() %></h3><%-- 这个 是可以获取 session 中的值 的  ，其他的不行, 务必保证不是空指针--%>
